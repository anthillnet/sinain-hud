"""POST sense events to the sinain-core relay (/sense, /motion).

Moved from sense_client/sender.py — the client side of the /sense contract,
usable by any surface that produces SenseEvents.
"""
