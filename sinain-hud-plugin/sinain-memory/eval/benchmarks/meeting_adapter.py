            ...
            for item in raw_questions:
                questions.append(BenchmarkQuestion(
                    ...
                    metadata={
                        ...
                        # Diarization Lever 4 — optional per-question speaker
                        # filter forwarded to query_facts_hybrid as
                        # mentioned_by_speaker. Absent / empty = no filter.
                        "speaker_filter": item.get("speaker_filter") or [],
                    },
                ))
