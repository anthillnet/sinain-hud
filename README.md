...
- Tested with Claude Code, OpenClaude, Codex, Goose, Junie, and [Hermes](https://github.com/NousResearch/Hermes-Agent) (NousResearch). Any MCP-compatible agent works.
